            ...
            <div className="modal-dialog modal-dialog-centered">
                <div className="modal-content">
                    <div className="modal-header">
                        <h1 className="modal-title fs-5" id="modalLoadingLabel">Your upload is being processed</h1>
                    </div>
                    <div className="modal-body d-flex justify-content-center align-items-center pb-5" style={{height: 200}}>
                        <div className="spinner-border" role="status"></div>
                    </div>
                    <button id='closeLoading' type="button" className="btn btn-secondary" data-bs-dismiss="modal" hidden>Close</button>
                </div>
            </div>
        </div>
    )
